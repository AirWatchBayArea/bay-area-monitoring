...
cr.LabelFormatter.VERBOSE_DAYS="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ");cr.LabelFormatter.MONTHS="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ");cr.LabelFormatter.VERBOSE_MONTHS="January February March April May June July August September October November December".split(" ");cr.TimeLabelFormatter=function(){};
cr.TimeLabelFormatter.prototype.format=function(a){var b=Math.floor(a+5E-7);a=Math.round(1E6*(a-b));var c=new Date(1E3*b),d=c.getHours(),b=12>d?"AM":"PM",d=12>d?d:d-12;0==d&&(d=12);d=String("00"+d).slice(-2)+":"+String("00"+c.getMinutes()).slice(-2);c=c.getSeconds();if(0!=c||0!=a)d+=":"+c,0!=a&&(d+="."+a);return d+b};cr.VerboseDateLabelFormatter=function(){this.dayFormatter=new cr.VerboseDayLabelFormatter;this.monthFormatter=new cr.VerboseMonthLabelFormatter(!0)};
