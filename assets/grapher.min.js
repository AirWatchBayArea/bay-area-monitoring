...
this._min=this.minConstraint):this._max<this.maxConstraint&&(this._min+=this.maxConstraint-this._max,this._max=this.maxConstraint);this.publishAxisChangeEvent();this.grapher.scheduleUpdate()};cr.GraphAxis.prototype.limitForcedView=function(){this._min<this.minRange?this._min=this.minRange:this._min>this.minConstraint&&(this._min=this.minConstraint);this._max>this.maxRange?this._max=this.maxRange:this._max<this.maxConstraint&&(this._max=this.maxConstraint);this.publishAxisChangeEvent();this.grapher.scheduleUpdate()};
