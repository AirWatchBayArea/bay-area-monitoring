var cr=cr||{};cr.Util=function(){};cr.Util.hexToRgb=function(a){a=a.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i,function(a,c,d,e){return c+c+d+d+e+e});return(a=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(a))?{r:parseInt(a[1],16),g:parseInt(a[2],16),b:parseInt(a[3],16)}:null};cr.Util.normalizeScrollDelta=function(a){var b=0,b=-1*a.originalEvent.deltaY;0!=b&&(b=Math[1<=b?"floor":"ceil"](b/Math.abs(b)));return b};
...
cr.GraphAxis.prototype.setMaxRange=function(a,b){var c=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};c(a)&&a>=cr.GraphAxis.Constants.DEFAULT_MIN_RANGE&&(!this.hasMinConstraint||a<=this.minConstraint)?(this.minRange=a,this.hasMinRange=!0):(this.minRange=cr.GraphAxis.Constants.DEFAULT_MIN_RANGE,this.hasMinRange=!1);c(b)&&b<=cr.GraphAxis.Constants.DEFAULT_MAX_RANGE&&(!this.hasMaxConstraint||b>=this.maxConstraint)?(this.maxRange=b,this.hasMaxRange=!0):(this.maxRange=cr.GraphAxis.Constants.DEFAULT_MAX_RANGE,
this.hasMaxRange=!1);this.update();this.grapher.scheduleUpdate();this.publishAxisChangeEvent()};
cr.GraphAxis.prototype.setMinRangeConstraints=function(a,b){var c=function(a){return!isNaN(parseFloat(a))&&isFinite(a)};c(a)&&a>=this.minRange?(this.minConstraint=a,this.hasMinConstraint=!0):(this.minConstraint=null,this.hasMinConstraint=!1);c(b)&&b<=this.maxRange?(this.maxConstraint=b,this.hasMaxConstraint=!0):(this.maxConstraint=null,this.hasMaxConstraint=!1);this.update();this.grapher.scheduleUpdate();this.publishAxisChangeEvent()};cr.GraphAxis.prototype.getId=function(){return this._div.id};
...
cr.TouchUtils=function(){};cr.TouchUtils.prototype._getX=function(a){return a instanceof Touch?a.pageX:a.x};cr.TouchUtils.prototype._getY=function(a){return a instanceof Touch?a.pageY:a.y};cr.TouchUtils.prototype.copyTouches=function(a){for(var b=[],c=0;c<a.length;c++)b.push({x:this._getX(a[c]),y:this._getY(a[c])});return b};
cr.TouchUtils.prototype.centroid=function(a){if(1==a.length)return{x:this._getX(a[0]),y:this._getY(a[0])};for(var b={x:0,y:0},c=0;c<a.length;c++)b.x+=this._getX(a[c]),b.y+=this._getY(a[c]);b.x/=a.length;b.y/=a.length;return b};cr.TouchUtils.prototype.xSpan=function(a){return Math.abs(this._getX(a[0])-this._getX(a[1]))};cr.TouchUtils.prototype.ySpan=function(a){return Math.abs(this._getY(a[0])-this._getY(a[1]))};cr.TouchUtils.prototype.isXPinch=function(a){return 2==a.length&&this.xSpan(a)>this.ySpan(a)};
cr.TouchUtils.prototype.isYPinch=function(a){return 2==a.length&&this.ySpan(a)>this.xSpan(a)};cr.TouchUtils.getElementPagePosition=function(a){var b={x:0,y:0};if(a){do b.x+=a.offsetLeft,b.y+=a.offsetTop,a=a.offsetParent;while(null!=a)}return b};cr.TouchUtils.filterTouchesForElement=function(a,b){var c=[];if(a&&0<a.length)for(var d=0;d<a.length;d++){var e=a[d];e.target&&e.target.id==b&&c.push(e)}return c};"use strict";cr=cr||{};
