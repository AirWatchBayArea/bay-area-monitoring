...
<body>
  ...
  <div id="reportDialog" title="Report Smell">
    ...
    <strong>How does your air smell right now? (required)</strong>
    <form id="report-form">
      <label>
      ...
      <label class='location-label'>Where were you when you detected the odor? (required)<br><input id="address" type="text" name="location" placeholder="e.g. at the corner of 7th and Hensley" required></label>
