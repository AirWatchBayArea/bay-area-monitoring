...
var createChart = function(feed, channelName, feedAPIKey) {
  ...
  if (idx != -1) {
    ...
    var $chemicalInfo = $(['<a class="chartButton user-guide-chem-link" title="View Health Info"href="https://docs.google.com/document/d/1RL5MGzxdswD37jXnv-9_Skl638ntj7_2OR87YZtcOoM/pub#h.y2qt3fnrqosf" target="_blank" data-localize="dashboard.chemical-info">',
                            '</a>'].join(''));
